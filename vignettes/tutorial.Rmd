...
Here we provide a brief tutorial of the `BayesChange` package. 
...
Functions `detect_cp_uni` and `detect_cp_multi` provide a method for detecting change points respectively on univariate and multivariate time series. 
...
Functions `clust_cp_uni` and `clust_cp_multi` provide a method for clustering respectively univariate and multivariate time series with common change points. 
...
Functions `clust_cp_epi` provide a method for clustering survival functions with common change points. 
